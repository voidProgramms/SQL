...
update typeOfProduct set typeOfProduct='капли' where ID_typeOfProduct=3;
...
values('ОАО "МосМед"');
insert into producers(producer)
values('ООО "ФранцГрупп"');
insert into producers(producer)
values('ЗАО "УГНМед"');

update producers set producer='ЗАО ГРОММед' where ID_producer=2;
delete from producers where producer='ЗАО "РусМед"';

insert into product(productName, productCode)
values('Нурафен', '43242');
insert into product(productName, productCode)
values('Доктор МОМ', '48294');
insert into product(productName, productCode)
values('Мирамистин', '65874');
insert into product(productName, productCode)
values('Гемотаген', '90328');
insert into product(productName, productCode)
values('Тизин', '63542');
...
values('выписка врача');
insert into conditionForIssuingProduct(conditionForIssuingProduct)
values('свободная продажа');
insert into conditionForIssuingProduct(conditionForIssuingProduct)
values('отсутствует');
